...
let eyeL = document.querySelector(".left-eyeball");
let eyeR = document.querySelector(".right-eyeball");
let handL = document.querySelector(".left-hand");
let handR = document.querySelector(".right-hand");
